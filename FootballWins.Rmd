...
ANSWER HERE: It's a semi-useful model due to how some factors of the model aren't as significant, yet the p-value is low suggesting significance. 
...
ANSWER HERE: Points scored has the most impact on wins and it's closely correlated to yards gained. Takeaways doesn't seem that impactful as the data shows no-relation between its influence on yards gained. 
...
ANSWER: I could use this model to cover the successes and losses made by each team in a game. I could analyze tactics in a game that do and do not benefit a team. 
