...
```{r}
Volleyball <- read_csv("https://raw.githubusercontent.com/dwillis/NCAAWomensVolleyballData/refs/heads/main/data/ncaa_womens_volleyball_matchstats_2024.csv")

```

### Task 3: Create totals of aces for each team using `group_by()` and `summarize()`
```{r}
total_aces <- Volleyball |>
  group_by(team) |>
...
In the dataset Maryland shows many wins compared to other M states teams such as marist. It also shows Maryland having a 223 total aces.  
