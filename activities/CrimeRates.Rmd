...
```{r}
crimes|> mutate(total_rate = violent_crime_total/population*10000)
crimes|> mutate(poperty_rate = property_crime_total/population*10000)
...
The year that has the highest crime rates in Maryland is 1981 with the total crimes reaching to 279,663 thousand. The lowest crime rate year is 2020 which reaches to 123,439 thousand. I suspect the pandemic had a role in the lower crime reported. 
