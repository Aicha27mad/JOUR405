...
```{r}
GDP |> summarize(corelation =cor(DJIA, GDP, method="pearson"))
...
Answer Here: In the scatterplot we have a high correlation at 0.9 between the two variables, which is higher than the average of 0.7. The scatterplot shows that a positive change in x results in a positive change in y. 
