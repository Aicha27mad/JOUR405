...
ANSWER HERE: The relationship between FARMS percentage and math test scores based on this data is that the percentage of free reduced lunch given to students does have a slight influence in their performance in school in this case math scores. The scatterplot line is linear, but the dots are not clustered together for the most part. It shows a weak-positive correlation. 
...
ANSWER HERE: This model is worth using due to the p-value as it higher than 0.05. The relationship between FARMS and math scores is significant. 
...
ANSWER HERE: WHITEMARSH Elementary School is the top for the largest difference between the predicted result and the actual math scores with only 26.1% of the met or exceeded math expectations. The prediction made was 71.9 and the absolute value was 45.8. STONY CREEK Elementary School is another with 46.2% students meeting or exceeding the math expectations. The prediction made was 71.9 and the absolute value was 25.72.  
...
ANSWER HERE: The conclusion I could draw on is that students might not have the necessary resources to do well on math tests including food. The story I could pitch is that free nutrients distributed by counties to students improve students well being in their performance and study. 