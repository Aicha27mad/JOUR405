...
PUT ANSWERS HERE: In the Summer/warmer days it looks to be more car thefts.
...
Answer Here : The chart does not change my answer from task three, it provides a visual component to it. 
...
PUT YOUR ANSWERS HERE: The 95% confidence interval shows the probability that the mean does falls within that range. The mean figure accurately reflects the number of car thefts in a typical month. "Seasonal Changes for Prince Georges County Car Thefts- but with a high confidence interval, it suggests no big change" could be a headline.
...
PUT ANSWERS HERE: The first half of the data showing 490 average of car thefts is larger than the second half which tells us the time period, perhaps influenced by the weather, effects the amounts of said crime committed. We cannot reject the null hypothesis since the value is larger than 0.05, which tells us there isn't much evidence to support whether there is a statistically significant difference between the two periods.
