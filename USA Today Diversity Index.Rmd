...
**ANSWER HERE** Baltimore city looks to stand out as the most populated community with the most homogeneous area. The city has the most population with Black, White and mixed race--Black being the largest, however the population consists of the largest Native Hawaiian and Paicific Islander data amount, which not every city has.
```{r load-data}
...
**ANSWER HERE**  Langley Park would have the highest race probability due to its smaller range of races and small sample size. 
...
**ANSWER HERE** The cities that have the lowest Hisp_Prob scores have the lowest population and that might be a reason since Hispanic is quite broad as anyone could be of Hispanic roots with any color. A lot of the cites are with no controlled government. 
...
**ANSWER HERE** The top three cites are as follows: Langley Park, Wheaton and Aldelphi. The least diverse city listed in the data is Lake Shore a census designated place in Maryland.
...
**ANSWER HERE** Headline/lede: "Small town lake Shore has the highest level of probability among races in Maryland" 
Langley Park, a town known for its affluence in such a small population shows to have the largest probability value with a notably high diversity index of 97.18%.   