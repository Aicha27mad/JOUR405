...
ANSWER HERE: The data shown is quite meaningnful beacuse of the unexpected grades such as 20 more A's than expected and less c's than expected. There could be possible trends that explains these reuslts. 
...
ANSWER HERE: Yes, in this result we rejct the null hypothesis because there is suffienct enough evidence with the critical value being 11.667 which is greater than the critcial value. 
...
ANSWER HERE: There are notable grades distributed that were more or less than expected. A's and C's are the top two grades that had the greatest difference between expected and observed. There could be inconsistency in the grades. Questions I would pose to the instructor or college are What makes you feel like the students weren't going to get A's?, What do you think the students did to earn these grades?, Did the student engagment or particpation level see a slight shift?, How often are there grading curves? 