...
Answer Here: New Sales Data shows Local officials claim that a new light rail line has increased property values in a local neighborhood proves to have an indirect effect with eachother. Home sales data shows house prices rose since the new light rail line was implemented. 
