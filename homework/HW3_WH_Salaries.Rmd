...
ANSWER HERE: The data shows people listed as employees or detailee's in the 
White House and their salary. Some people are paid more then others with Associate Counsel, Michelle M. Barrans having the largest salary of 251,258 dollars. 
...
Been trying to make the calculation, but it's not working.
```{r}
wh_salaries |>
...
ANSWER HERE: During the calculations with the functions I ran it several times and each time was not spotless until I finally did it right yet no numbers would show up and the number that did for the maximum was incorrect. There are about eleven outliers in the data that shows a zero salary for such people. 

### Task 7: Story Idea

Based on the data, what is your best story idea? What is the next step you would take to develop that story idea?

ANSWER HERE: A story about roles in the White House and their importance would be an angle that would get to the bottom of why some people are paid more than others. I would go to the white house and ask questions, or I could go on the internet and research the jobs and look at their responsibities. 
