...
In this data between SAT scores in Community, Private and Public colleges it displays the mean, median, standard deviation, min and max of students performance. Community college shows to have the lowest means score with a more spread out data by a high standard deviation. Private college had the highest mean score and the lowest standard deviation. Public college is in the middle of the mean SAT score with a balance between the two other institutions in terms of a spread of scores.
...
Answer: Yes, there is a significant difference in SAT scores across college types.
2. Which specific college types differ from each other?
Answer: Public vs Community, Private vs Public colleges differ from eachother aswell as private and community colleges, which shows the largest difference.   
3. How large are these differences?
Answer: The mean SAT scores for public colleges is 74.40 points lower than private colleges on average. The mean SAT scores for private colleges is 366.96 points higher than the community colleges on average. Public colleges is 292.55 points higher than community colleges on average.
...
"Public, Private and Community colleges show a drastic difference in SAT scores among students" 
Lede: Recent data finds that there's is a possible correlation between college types and SAT performances with private colleges besting out Community and Public colleges. 
