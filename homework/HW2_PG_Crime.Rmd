...
```{r}
pg_crimes <- pg_crimes |> mutate (average_incidents = (`January, February, march, April, may, June, July, August, September, October, November, December 
...
ANSWER HERE: Prince Georges County crimes increase in the winter season and accidents seem to be the 
