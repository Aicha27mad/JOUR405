...
1. How does weighting affect our estimates of voting intentions?
   Answer: Weighting helps reduce biases 
2. Which demographic groups show the largest differences between weighted and unweighted results?
   Answer: The rarely/never demographic shows the largest differences between weighted and unweighted results. 
3. How might weighting influence reporting of this data?
   Answer:It might influence how confident politicians or such feel about encouraging people to vote.
...
1. Which voter category shows the biggest difference between weighted and unweighted results?
   Answer: The rarely/never category shows the biggest difference between weighted and unweighted results. 
2. How might these differences affect reporting on likely voter turnout?
  Answer: It might lead to a over expectation in voting turnout amongst people that may not hold up.
3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample?
 Answer: These difference exist due to some reporter and researches not weighting in their data. 
