...
ANSWER HERE: I notice that there are many calls made notable spikes on various days such as in February. Many days had over 25 overdose calls. If had to draw horizontal lines that would highlight unusual days it would be days where there was an overwhelming amount of overdose calls and days where there were fewer calls like on february tenth of 2022.
...
ANSWER HERE:  My impressions of the raw data that contained many dates and times make me realize how excessive sevreal days were in regards to 911 overdose calls.
...
ANSWER HERE: I would describe it as February seventh having the highest z-score since it went above the mean for overdose calls, standing out from all the other data, suggesting a possible trend.
...
ANSWER HERE: Potential angles could be that in the end of the year, there tends to be more overdose incidents than in the beginning of the year. The days could happen to be a day where a particular events took place. The days where there are fewer overdose calls, it could be a slow week. I might tell my editor that the days where frequent overdose related calls occurred needs to be researched on and could be linked to a trend.
