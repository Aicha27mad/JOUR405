...
ANSWER HERE: In the data for Maryland voter turnout it shows the older generation is more likely to vote in the elections. 
The counties with the higher white population seems to have a higher voter turnout as well where Garrett county had 95.5% of people who voted. 
...
ANSWER HERE: Higher income and voter turnout looks to have weak-positive correlation between each other. The population coefficient is negative and is not significant based on the data and graph. Education looks to have a weak-positive correlation with voter turnout. Yes, counties with older populations have voter turnout rates that are significantly higher. The relationship between unemployment and voter turnout is a negative correlation with -74% of the voter turnout. There looks to be a strong-positive relationship between racial composition and turnout with the white demographic turning out more numbers in the elections with 69%.
...
ANSWER HERE: A couple models that trump that other models statistically are pct_white and median_age.
...
ANSWER HERE: To cover an election or voter turnout, I could use this analysis to compare the factors of a sample and determine the plausible reasons to voters v. non-voters. The story will provide insights on trends such as low-income counties not showing out to vote and higher-degree sought people showing out to vote for public awareness. 
