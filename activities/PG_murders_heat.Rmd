...
```{r}
murders |> summarize(corelation =cor(murders,temperature, method ="pearson"))
...
Answer Here: There is a weak positive correlation. The correlation is 0.5 rather than zero and the scatterplot shows that weak correlation. 
